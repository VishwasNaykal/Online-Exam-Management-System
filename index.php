    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Sudeen S </a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9113527175</h4>
		<h4 style="font-family:'typo' ">sudeenssss@gmail.com</h4>
		<h4 style="font-family:'typo' ">Vivekananda Institute of Technology</h4></div></div>
		</p>
      </div>
