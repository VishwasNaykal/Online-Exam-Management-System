  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Chandan Kumar R" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Chandan kumar R</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9113527175</h4>
		<h4 style="font-family:'typo' ">chandankumarmr.ck@gmail.com</h4>
		<h4 style="font-family:'typo' ">Dr Ambedkar Institute Of Technology</h4></div></div>
		</p>
      </div>
